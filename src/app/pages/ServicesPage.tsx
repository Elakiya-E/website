      ...
      <section className="relative overflow-hidden py-24 md:py-32">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              <span className="text-sm font-semibold text-primary">Solutions</span>
            </motion.div>

            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-foreground">
              AI-Powered Growth Solutions <span className="text-primary">by Industry</span>
            </h1>
            ...
            {solutions.map((solution, index) => (
              ...
              >
                <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-2">{solution.title}</h2>
                  <h3 className="text-xl font-semibold text-primary mb-4">{solution.subtitle}</h3>
                  ...
                  {solution.designedFor && (
                    <div className="mb-6">
                      <h4 className="font-bold text-foreground mb-3 border-b border-gray-100 pb-2">Designed For</h4>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-primary rounded-3xl p-8 md:p-16 relative overflow-hidden text-white shadow-2xl"
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                >
                  <Link
                    to="/contact"
                    className="inline-flex items-center px-8 py-4 bg-white text-primary rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-lg font-bold text-lg"
                  >
                    Get a Free Audit
                    <ArrowRight className="ml-2" size={20} />
                  </Link>
